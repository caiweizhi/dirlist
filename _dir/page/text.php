...
<head>
    <meta charset="utf-8" />
    <title>文本查看器</title>
    <link rel="stylesheet" href="<?php echo $cdnpublic?>highlight.js/11.11.1/styles/github.min.css">
...
<script src="<?php echo $cdnpublic?>highlight.js/11.11.1/highlight.min.js"></script>
